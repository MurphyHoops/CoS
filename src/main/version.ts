...
export const COMPANION_BUILD_ID = 'cos-3.1.2-companion-diagnostics-v1';
...
export function extensionDownloadUrl(version = APP_VERSION): string {
  return `https://github.com/MurphyHoops/CoS/releases/download/v${encodeURIComponent(version)}/Chat-On-Steroids-Extension.zip`;
}
